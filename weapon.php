...
<div id="content">
	<div id="colOne">
		<h2>History of  Indian Arms & Weponery</h2><br />
	    <!--	<p><small>Management System</small></p>-->
		<?php
//require 'db_open.php';
 $con = mysql_connect('localhost', 'root', '') or die(mysql_error());
        $db = mysql_select_db('museum_management', $con);
   $query = "SELECT id,alt,img_name,name,artist,discription,weight,components FROM artifects WHERE location='Arms and Armour Gallery'";
