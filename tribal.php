...
<div id="content">
	<div id="colOne">
		<h2>Trible Art &amp; Lifestyle  Gallery</h2>
		<br />
...
//require 'db_open.php';
 $con = mysql_connect('localhost', 'root', '') or die(mysql_error());
   ...
   $query = "SELECT id,alt,img_name,name,artist,discription,weight,components FROM artifects WHERE location='Trible Life Style Gallery'";
